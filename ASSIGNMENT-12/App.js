...
function App() {
  ...
  const addnewProductHandler=(product)=>{
    ...
    let productobj={
      ...
      product_conducted_by:product.productConductedBy
    ...
    <div className="App">
      ...
      <h1>Listed Products Are </h1>
       {products.map((product,index)=>
        <Product key={index} id={product.product_id}name={product.product_name}
        image={product.product_image}
        price={product.product_price}
        product_conducted_by={product.product_conducted_by}/>
